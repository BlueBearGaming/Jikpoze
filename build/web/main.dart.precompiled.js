...
function dart_precompiled($collectedClasses) {
  ...
  function JSInvocationMirror(__js_helper$_memberName, _internalName, __js_helper$_kind, _arguments, _namedArgumentNames, _namedIndices) {
    this.__js_helper$_memberName = __js_helper$_memberName;
    this._internalName = _internalName;
    this.__js_helper$_kind = __js_helper$_kind;
  ...
  function IsoBitmap(bitmapData, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _shadow, _compositeOperation, _filters, _cacheTextureQuad, _cacheDebugBorder, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, userData, _eventStreams) {
  ...
  IsoBitmap.builtin$cls = "IsoBitmap";
  if (!"name" in IsoBitmap)
    IsoBitmap.name = "IsoBitmap";
  $desc = $collectedClasses.IsoBitmap;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IsoBitmap.prototype = $desc;
  ...
  function BitmapData(_stagexl$_width, _stagexl$_height, _renderTexture, _renderTextureQuad) {
  ...
  function BitmapDataLoadOptions(png, jpg, webp, autoHiDpi, corsEnabled) {
    this.png = png;
    this.jpg = jpg;
    this.webp = webp;
  ...
  function _MouseButton(mouseDownEventType, mouseUpEventType, mouseClickEventType, mouseDoubleClickEventType, target, buttonDown, clickTime, clickCount) {
  ...
  function _Touch(touchPointID, primaryTouchPoint, target, currentTarget) {
  ...
  _Touch.prototype.get$currentTarget = function(receiver) {
    return this.currentTarget;
  };
  _Touch.prototype.set$currentTarget = function(receiver, v) {
    return this.currentTarget = v;
  };
  ...
  function Stage__onTouchEventProcessor_closure(this_0, target_1) {
    this.this_0 = this_0;
    this.target_1 = target_1;
  }
  Stage__onTouchEventProcessor_closure.builtin$cls = "Stage__onTouchEventProcessor_closure";
  if (!"name" in Stage__onTouchEventProcessor_closure)
    Stage__onTouchEventProcessor_closure.name = "Stage__onTouchEventProcessor_closure";
  $desc = $collectedClasses.Stage__onTouchEventProcessor_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Stage__onTouchEventProcessor_closure.prototype = $desc;
  ...
  function RenderContextWebGL(_canvasElement, _renderProgramQuad, _renderProgramTriangle, _renderFrameBufferPool, _renderingContext, _renderTexture, _renderProgram, _renderFrameBuffer, _contextValid, _contextIdentifier, _stencilDepth, _viewportWidth, _viewportHeight, _eventStreams) {
    this._canvasElement = _canvasElement;
    ...
    this._contextValid = _contextValid;
    this._contextIdentifier = _contextIdentifier;
  ...
  function RenderProgramQuad(_vertexShaderSource, _fragmentShaderSource, _contextIdentifier, _renderingContext, _program, _vertexBuffer, _indexBuffer, _indexList, _vertexList, _aVertexPositionLocation, _aVertexTextCoordLocation, _aVertexAlphaLocation, _quadCount) {
  ...
  function RenderProgramTriangle(_vertexShaderSource, _fragmentShaderSource, _contextIdentifier, _renderingContext, _program, _vertexBuffer, _vertexList, _aVertexPositionLocation, _aVertexColorLocation, _triangleCount) {
    this._vertexShaderSource = _vertexShaderSource;
    this._fragmentShaderSource = _fragmentShaderSource;
    this._contextIdentifier = _contextIdentifier;
    this._renderingContext = _renderingContext;
  ...
  function RenderTexture(_stagexl$_width, _stagexl$_height, _transparent, _storePixelRatio, _storeWidth, _storeHeight, _canvas, _quad, _contextIdentifier, _renderingContext, _texture) {
    this._stagexl$_width = _stagexl$_width;
    this._stagexl$_height = _stagexl$_height;
  ...
  function MouseEvent(localX, localY, stageX, stageY, deltaX, deltaY, buttonDown, clickCount, altKey, ctrlKey, shiftKey, _type, _bubbles, _eventPhase, _stagexl$_target, _currentTarget, _stopsPropagation, _stopsImmediatePropagation) {
    this.localX = localX;
    this.localY = localY;
    this.stageX = stageX;
    this.stageY = stageY;
  ...
  MouseEvent.prototype.get$stageX = function() {
    return this.stageX;
  };
  MouseEvent.prototype.get$stageY = function() {
    return this.stageY;
  };
  MouseEvent.prototype.get$deltaX = function(receiver) {
    return this.deltaX;
  };
  MouseEvent.prototype.get$deltaY = function(receiver) {
    return this.deltaY;
  };
  ...
  function TouchEvent(touchPointID, isPrimaryTouchPoint, localX, localY, stageX, stageY, altKey, ctrlKey, shiftKey, _type, _bubbles, _eventPhase, _stagexl$_target, _currentTarget, _stopsPropagation, _stopsImmediatePropagation) {
    this.touchPointID = touchPointID;
  ...
  TouchEvent.prototype.get$touchPointID = function() {
    return this.touchPointID;
  };
  TouchEvent.prototype.get$stageX = function() {
    return this.stageX;
  };
  TouchEvent.prototype.get$stageY = function() {
    return this.stageY;
  };
  ...
  MouseCursorData.builtin$cls = "MouseCursorData";
  if (!"name" in MouseCursorData)
    MouseCursorData.name = "MouseCursorData";
  $desc = $collectedClasses.MouseCursorData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MouseCursorData.prototype = $desc;
  function _ImageLoader(_image, _completer, _url, _onLoadSubscription, _onErrorSubscription) {
    this._image = _image;
    this._completer = _completer;
    this._url = _url;
    this._onLoadSubscription = _onLoadSubscription;
    this._onErrorSubscription = _onErrorSubscription;
  }
  _ImageLoader.builtin$cls = "_ImageLoader";
  if (!"name" in _ImageLoader)
    _ImageLoader.name = "_ImageLoader";
  $desc = $collectedClasses._ImageLoader;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _ImageLoader.prototype = $desc;
  ...
  function _checkWebpSupport_closure() {
  }
  ...
  function _checkWebpSupport_closure0() {
  }
